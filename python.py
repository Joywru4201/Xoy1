...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            XUS TIN
\033[1;37m Facebook:            XUS TIN
\033[1;37m Github  :            Joywru42
\033[1;37m Version :            2024
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://facebook.com/groups/2974791062620132/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +xustin)
    os.system('sort -r '+ssb+' | uniq > '+xustin)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + XUSTIN )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
